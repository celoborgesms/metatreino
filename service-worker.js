const CACHE_NAME = "metatreino-cache-v0.1.2-correcoes-seguranca-plano";

const APP_SHELL = [
  "./",
  "./index.html?v=0.1.2",
  "./manifest.json?v=0.1.2",
  "./icon-512.png.png?v=0.1.2"
];
    ...
    event.respondWith(
      fetch(event.request)
        .then(function(response) {
          ...
          caches.open(CACHE_NAME).then(function(cache) {
            cache.put("./index.html?v=0.1.2", copy);
            cache.put("./index.html", response.clone());
          });
          return response;
        })
        .catch(function() {
          return caches.match("./index.html?v=0.1.2").then(function(cached) {
